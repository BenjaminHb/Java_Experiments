...
abstract class StateOrOutStateStudent {     //定义一个抽象类，子类继承抽象类，并只需要自定义billPer即可
...
class JavaStateUniversityStudent extends StateOrOutStateStudent {       //继承抽象类
    final double billPer = 75;
}

class OutStateStudent extends StateOrOutStateStudent {      //继承抽象类
    final double billPer = 200;
}
...
public class Exercise5_17 {
    public static void main(String[] args) throws ParseException {
        ...
        javaStu.bill = javaStu.billPer * 120;
        outStu.bill = outStu.billPer * 120;
